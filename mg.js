...
(function () {
  ...
  /* =========================================================================
     ...
     (a) SAHİP OLANLARDAN (retitled from İÇ SES, owner wave-3.1) — swipeable
         ...
         Owner wave-3.2 2026-07-14: "doesn't look like a review" — review
         anatomy without fabricated identity; most compelling card leads,
         four new angles (cost-of-cheap, on-the-skin comfort, after-forty,
         gift box). Wave-3.3 same night: the UPPERCASE angle kickers read
         "robot" to the owner → kickers removed; the human element is the
         per-card SIGNATURE line: sentence-case anonymous person sketches
         ("— İki doğum yapmış bir sahibi"), varied like real attributions.
         Wave-3.4 2026-07-14: the uniform "… bir sahibi" signature (×14)
         still read as a filled-in template to the owner, who asked for
         human, name-like headers. Resolution (Mira): NOT fabricated names
         — each card gains a HUMAN PULL-QUOTE headline (h) lifted from its
         own body (the emotional peak, e.g. "Bu para harcanmadı, yerine
         kondu."); the 14 signatures are de-templated (moment/age/role,
         3 keep the "Bir sahibi, …" anchor); the header carries a REAL
         count (2,104 historical customers → "2.000'den fazla kadın
         silüetine sahip oldu.", distinct from the ~20k follow count in
         the MOTION header). Bodies (q) unchanged — owner: "paragraflar iyi".
  ...
  (function () {
    ...
    css(
      ...
      ".mg-ics-hd{display:flex;align-items:flex-start;justify-content:space-between;max-width:1162px;margin:0 auto;padding:0 24px;}" +
      ".mg-ics-hl{display:flex;flex-direction:column;}" +
      ".mg-ics-k{font-size:9px;font-weight:600;letter-spacing:.24em;color:#888;}" +
      ".mg-ics-sub{display:block;margin-top:9px;font-size:12.5px;font-weight:400;letter-spacing:.01em;color:#6a6a6a;line-height:1.5;max-width:520px;}" +
      ...
      ".mg-ics-card{flex:0 0 auto;width:min(340px,82vw);scroll-snap-align:center;border:1px solid #e6e4e0;background:#fff;padding:28px 28px 24px;box-sizing:border-box;display:flex;flex-direction:column;}" +
      ".mg-ics-h{font-size:16px;font-weight:400;line-height:1.42;color:#0d0d0d;margin:0 0 13px;text-align:left;}" +
      ".mg-ics-card p:not(.mg-ics-h){font-size:13.5px;font-weight:300;line-height:1.95;color:#1a1a1a;margin:0;text-align:left;flex:1 1 auto;}" +
      ".mg-ics-sig{display:block;margin-top:20px;padding-top:12px;border-top:1px solid #efedeb;font-size:11px;font-weight:400;letter-spacing:.02em;color:#8a8a8a;text-align:left;}" +
    ...
    /* Wave-3.2/3.3 2026-07-14: fourteen first-person persona comments
       (Selin). Owner: more angles, the most compelling card leads and
       pulls the rest, and the cards must READ as comments — wave-3.3:
       uppercase kickers felt robotic, so each card instead carries a
       HUMAN anonymous signature (s), sentence-case, varied like real
       attributions; identity stays fabricated-free (no names/stars/dates
       — see section header note). Order:
    ...
    var VOICES = [
      { h: L("He couldn't take his eyes off me all evening.", "Bütün akşam gözünü benden alamadı."), s: L("— An owner, after that evening", "— Bir sahibi, o akşamın ardından"), q: L("“The look on his face when I walked through the door was worth everything. He couldn't take his eyes off me all evening. I'll keep it short: buy it knowing its effect.”", "“Kapıdan girdiğimde yüzündeki ifade her şeye değdi. Bütün akşam gözünü benden alamadı. Sözü uzatmayayım: etkisini bilerek alın.”") },
      { h: L("This money wasn't spent — it was put in its place.", "Bu para harcanmadı, yerine kondu."), s: L("— She thought for two days, then came back", "— İki gün düşünüp döndü"), q: L("“I saw the price and closed the page; two days later I came back. I asked myself when I had last set something like this aside for myself, and I didn't like the answer. In front of the mirror the argument ended: this money wasn't spent, it was put in its place.”", "“Fiyatı görünce sayfayı kapattım, iki gün sonra geri döndüm. Kendime en son ne zaman böyle bir şey ayırdığımı düşündüm ve cevap hoşuma gitmedi. Aynanın karşısında tartışma bitti: bu para harcanmadı, yerine kondu.”") },
      { h: L("My body hadn't changed; the way I saw it had.", "Vücudum değişmemişti; bakışım değişti."), s: L("— A mother of two", "— İki çocuk annesi"), q: L("“After two births my mirror and I were not on good terms. The evening I wore this I looked at myself without flinching. My body hadn't changed; the way I looked at it had.”", "“İki doğumdan sonra aynayla aram iyi değildi. Bunu giydiğim akşam kendime baktım, kaçırmadan. Vücudum değişmemişti; benim ona bakışım değişti.”") },
      { h: L("I didn't recognise my own posture.", "Kendi duruşumu yadırgadım."), s: L("— One who looks for flaws first", "— Önce kusur arayan"), q: L("“I'm the kind who looks for flaws first; the seams and the clasps were the first things I checked. I found none. The first evening I wore it I didn't recognise my own posture — apparently I'd been carrying my shoulders low all along.”", "“Ben önce kusur arayan biriyim; elime aldığımda ilk baktığım yer dikişler ve kopçalardı. Bulamadım. Üzerimde olduğu ilk akşam kendi duruşumu yadırgadım — meğer omuzlarımı hep düşük taşıyormuşum.”") },
      { h: L("One proper piece was the answer.", "Bir kez doğrusunu almak varmış."), s: L("— She tried the cheap ones and gave up", "— Ucuzunu deneyip vazgeçmiş"), q: L("“The ones I bought before are still in a drawer; I never wore any of them twice. Buying cheap meant buying again — I did that maths late. One proper piece was the answer.”", "“Çekmecemde daha önce aldıklarım duruyor; hiçbirini ikinci kez giymedim. Ucuza kaçtıkça yeniden alıyormuşum — bu hesabı geç yaptım. Bir kez doğrusunu almak varmış.”") },
      { h: L("My mind is at ease; I'm choosing my second.", "İçim rahat; şimdi ikincisini seçiyorum."), s: L("— She hesitated at her first order", "— İlk siparişinde tereddüt etmişti"), q: L("“I'll be honest, trusting a brand I didn't know wasn't easy; after ordering I asked myself twice whether I'd done the right thing. The tracking code arrived and I followed every step on the screen. When the parcel reached me, the first thing I did was check the seams. My mind is at ease now; I'm choosing my second.”", "“Açık konuşayım, bilmediğim bir markaya güvenmek kolay değildi; sipariş verdikten sonra iki kez ‘doğru mu yaptım’ diye düşündüm. Takip kodu geldi, her adımı ekrandan izledim. Paket elime geçtiğinde ilk işim dikişlere bakmak oldu. İçim rahat, şimdi ikincisini seçiyorum.”") },
      { h: L("I was the only one who knew what was inside.", "İçinde ne olduğunu bir tek ben biliyordum."), s: L("— One who kept it to herself", "— Sırrını kendine saklayan"), q: L("“It arrived in a plain parcel; I was the only one who knew what was inside. Even opening it was a pleasure. I'll leave the rest untold.”", "“Kargo elime sade bir paketle ulaştı; içinde ne olduğunu bir tek ben biliyordum. Açarken bile keyif aldım. Gerisini anlatmayayım.”") },
      { h: L("At night I didn't want to take it off.", "Gece çıkarmak içimden gelmedi."), s: L("— She was wary of delicate fabrics", "— İnce kumaştan çekinirdi"), q: L("“Delicate things usually bother me, so I hesitated. All evening I forgot I was wearing it; at night I didn't want to take it off. Grace and comfort can live in the same piece.”", "“İnce şeyler beni rahatsız eder diye çekinirdim. Akşam boyunca üzerimde olduğunu unuttum; gece çıkarmak içimden gelmedi. Zarafetle rahatlık aynı parçada durabiliyormuş.”") },
      { h: L("It sat exactly right — nothing left to chance.", "Tam oturdu; hiçbir şey şansa bırakılmamış."), s: L("— Caught between two sizes", "— İki beden arasında"), q: L("“I'm always sceptical about sizing; I sit between two sizes. I took my measurements, checked them against the table and ordered the size it suggested — it sat exactly right. Nothing about it felt left to chance.”", "“Beden konusunda hep şüpheciyim; iki bedenin arasındayım. Ölçülerimi aldım, tabloyla karşılaştırdım, önerilen bedeni aldım — tam oturdu. Hiçbir şey şansa bırakılmamış, bu belli.”") },
      { h: L("The best thing I'd done for myself in a long time.", "Uzun zamandır kendim için yaptığım en iyi şey."), s: L("— An owner, in an hour of her own", "— Bir sahibi, kendine ayırdığı bir saatte"), q: L("“No one was going to see it; only I would know. I came home from work, put it on and drank my coffee like that. It sounds small, but that one hour was the best thing I'd done for myself in a long time.”", "“Kimse görmeyecekti; sadece ben bilecektim. Akşam işten döndüm, giydim, kahvemi öyle içtim. Kulağa küçük geliyor ama o bir saat, uzun zamandır kendim için yaptığım en iyi şeydi.”") },
      { h: L("It was never about age.", "Mesele yaş değilmiş."), s: L("— Just past forty", "— Kırkını yeni geçmiş"), q: L("“After forty I told myself these were no longer for me. I was wrong. It was never about age; it is about how a woman looks at herself. This is how I look at myself now.”", "“Kırkımdan sonra bunlar bana göre değil diye düşünürdüm. Yanılmışım. Mesele yaş değilmiş; kadının kendine nasıl baktığıymış. Ben artık böyle bakıyorum.”") },
      { h: L("That night we both won.", "O gece ikimiz de kazandık."), s: L("— She opened it as a gift", "— Kutuyu hediye olarak açmış"), q: L("“The box came from him; I didn't know what was inside until I opened it. I'm glad I didn't. That night we both won. The next one we will choose together.”", "“Kutu ondan geldi; açana kadar içinde ne olduğunu bilmiyordum. İyi ki bilmiyormuşum. O gece ikimiz de kazandık. Bir sonrakini birlikte seçeceğiz.”") },
      { h: L("We came home early.", "Eve erken döndük."), s: L("— An owner, on an anniversary", "— Bir sahibi, yıl dönümünde"), q: L("“I bought it for our anniversary; it was the first time I'd paid for something like this. There was a dinner reservation. We came home early.”", "“Yıl dönümümüz için aldım; ilk kez böyle bir şeye para verdim. Akşam yemeği rezervasyonumuz vardı. Eve erken döndük.”") },
